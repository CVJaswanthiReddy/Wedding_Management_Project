...
<body bgcolor="#9FE2BF">
    <h1 align="center" style="color: black;"><i>Welcome to Wedding Management</i></h1>
    <marquee>
  ...
  <br>
    ...
    <div class="row">
        ...
        <form action="regi.php" method="get" onsubmit="return validateForm()">
            ...
            <label for="phnum" class="form-label" style="color:black;" ><b>Mobile</b></label>
            <input type="tel" name="mobile" class="form-control" required id="name" placeholder="enter name">
    ...
    <script>
        function validateForm() {
            ...
            var confirmPassword=document.getElementById("cpwd").value;
             var phnum=document.getElementById("mobile").value;
